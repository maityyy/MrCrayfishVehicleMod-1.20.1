...
public class ATVRenderer extends AbstractLandVehicleRenderer<ATVEntity>
{
    ...
    protected void render(@Nullable ATVEntity vehicle, PoseStack matrixStack, MultiBufferSource renderTypeBuffer, float partialTicks, int light)
    {
        ...
        //InteractionHandle bar transformations
        ...
        RenderUtil.renderColoredModel(SpecialModels.ATV_HANDLES.getModel(), ItemDisplayContext.NONE, false, matrixStack, renderTypeBuffer, this.colorProperty.get(vehicle), light, OverlayTexture.NO_OVERLAY);
